      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-10 lg:px-20 py-8 overflow-y-auto">
        <div className="w-full max-w-sm mx-auto">
          ...
          <div className="mt-8 space-y-3">
            <button onClick={oauth} className="w-full flex items-center justify-center gap-3 border border-[#0A0A0A]/12 rounded-xl py-3 text-sm font-medium hover:bg-[#0A0A0A]/[0.03] transition">
          ...
          <p className="text-center text-sm text-[#0A0A0A]/50 mt-5">
          ...
          <p className="text-center text-[11px] text-[#0A0A0A]/35 mt-8 leading-relaxed">
