      ...
      <div className="flex-1 flex items-center justify-center px-5 py-10">
        <div className="w-full max-w-xl text-center">
          ...
          <div className="relative w-24 h-24 mx-auto">
            ...
            <div className="relative w-24 h-24 rounded-full bg-[#FF4500] grid place-items-center text-white text-5xl shadow-[0_20px_40px_-15px_rgba(255,69,0,0.7)]">✓</div>
          </div>

          <h1 className="text-[clamp(30px,6vw,52px)] font-black tracking-[-0.02em] mt-8 leading-tight">
          ...
          <div className="grid sm:grid-cols-2 gap-4 mt-10 text-left">
            <a href={WHATSAPP_GROUP} target="_blank" rel="noreferrer"
              ...
              <h3 className="font-black text-lg mt-3">Rejoindre le WhatsApp</h3>
              <p className="text-[#0A0A0A]/55 text-sm mt-1">Le groupe officiel des testeurs Buyticle.</p>
              <span className="inline-flex items-center gap-1 text-[#128C4A] font-semibold text-sm mt-4 group-hover:gap-2 transition-all">Ouvrir le groupe →</span>
            </a>
            ...
            <Link to="/testers/tests"
              ...
              <div className="text-3xl">📝</div>
              <h3 className="font-black text-lg mt-3">Donner mon avis</h3>
              <p className="text-[#0A0A0A]/55 text-sm mt-1">Choisissez un test et partagez votre retour.</p>
              <span className="inline-flex items-center gap-1 text-[#FF4500] font-semibold text-sm mt-4 group-hover:gap-2 transition-all">Voir les tests →</span>
            </Link>
          </div>
