...
function ScheduleModal({ open, onClose, employees, initial, editingId }) {
  ...
  return (
    <>
      ...
      <div className="fixed z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[min(92vw,420px)] bg-white rounded-2xl shadow-2xl border border-slate-200 p-5">
