...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#E8E5E1] border-t border-[#0A0A0A]/10">
      <div className="max-w-[1400px] mx-auto px-6 md:px-14 pt-20 pb-10">
        <div className="grid grid-cols-12 gap-8 pb-16 border-b border-[#0A0A0A]/10">
          ...
          <div className="col-span-12 md:col-span-5">
            ...
            <div className="flex items-center gap-5 mt-8">
              {[
                ...
                { label: "Facebook", href: "#", d: "M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" },
          ...
          <div className="col-span-6 md:col-span-3 md:col-start-8">
            <p className="text-[#0A0A0A]/30 text-[10px] font-mono tracking-[0.35em] uppercase mb-6">Navigation</p>
            <ul className="space-y-4">
              {[
                ...
                <li key={l.label}>
                  <a href={l.href}
                    className="text-[#0A0A0A]/50 hover:text-[#0A0A0A] text-sm transition-colors duration-200 relative after:absolute after:bottom-0 after:left-0 after:h-px after:w-0 after:bg-[#0A0A0A] hover:after:w-full after:transition-all after:duration-300"
                  >
                    {l.label}
                  </a>
                </li>
          ...
          <div className="col-span-6 md:col-span-2 md:col-start-11">
            <p className="text-[#0A0A0A]/30 text-[10px] font-mono tracking-[0.35em] uppercase mb-6">Contact</p>
            <ul className="space-y-4">
              <li>
                <a href="mailto:contact@buyticle.com"
                  className="text-[#0A0A0A]/50 hover:text-[#0A0A0A] text-sm transition-colors duration-200 break-all"
                >
              ...
              <li>
                <a href="/privacy-policy"
                  className="text-[#0A0A0A]/50 hover:text-[#0A0A0A] text-sm transition-colors duration-200"
                >
                  Confidentialité
                </a>
              </li>
